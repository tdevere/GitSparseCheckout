...
Each test contains 10 questions, one point each. Maximum score: 10.

```
Score 0–4  : Foundation knowledge gaps — plan follow-up coaching
Score 5–7  : Developing understanding — review missed questions as a group
Score 8–10 : Strong baseline / mastery
```
...
*Expected answer*: not a bug; cone mode always materialises root-level tracked
...
*Expected answer*: pattern mode does not materialise root files unless
...
*Key discussion points*: agent version matters; always ask for agent version
...
*Expected answer*: check `GIT_CONE_MODE` — if `true`, directories won instead
...
*Module version: 1.0 — Based on authoritative builds 705, 709, 710, 712.*  
*Agent: v4.266.2 / git 2.43.0 / Linux (Ubuntu, MCAPDevOpsOrg Default pool)*
