...
> These are VALE's expected answers to the 10-question pre-test in
...
**Expected pre-test score: 1–2 / 10**
...
**Expected post-test score: 8–9 / 10**  
...
*Profile version 1.0 — February 24, 2026*  
*Calibrated against: `docs/LearningModule-SparseCheckout.md` v1.0*  
*Target module audience: Azure DevOps Support Engineers L1–L3*
